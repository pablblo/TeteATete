...
<script>
    ...
    function saveCourseChanges() {
        ...
        fetch('actions/update_course.php', {
            method: 'POST',
            headers: {
                'Content-Type': 'application/x-www-form-urlencoded'
            },
...
<script>
    function deleteCourse(courseId) {
        if (confirm("Êtes-vous sûr de vouloir supprimer ce cours ?")) {
            fetch('actions/delete_course.php', {
                method: 'POST',
                headers: {
                    'Content-Type': 'application/x-www-form-urlencoded'
                },
...
function deleteQuestion(questionId) {
    if (confirm('Êtes-vous sûr de vouloir supprimer cette question ?')) {
        fetch('actions/delete_question.php', {
            method: 'POST',
            headers: { 'Content-Type': 'application/x-www-form-urlencoded' },
    ...
    function sendWarning(userId) {
        ...
        fetch('actions/send_warning_ajax.php', {
            method: 'POST',
            headers: { 'Content-Type': 'application/x-www-form-urlencoded' },
    ...
    function updateAdminStatus(userId, newStatus) {
        fetch('actions/update_admin_status_ajax.php', {
            method: 'POST',
            headers: { 'Content-Type': 'application/x-www-form-urlencoded' },
