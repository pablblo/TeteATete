    ...
    if (!filter_var($email, FILTER_VALIDATE_EMAIL)) {
        ...
        if ($user) {
            ...
            try {
                ...
                $mail->Body = "Cliquez sur ce lien pour réinitialiser votre mot de passe : <a href='index.php?cible=generique&function=changer_mot_de_passe&token=" . $token . "'>Réinitialiser le mot de passe</a>";
                $mail->AltBody = "Cliquez sur ce lien pour réinitialiser votre mot de passe : http://localhost/TeteATete/index.php?cible=generique&function=changer_mot_de_passe&token=" . $token;
        ...
        <div class="login-container">
            <div class="form-container">
                ...
                <form action="" method="POST">
                    ...
                    <div class="links">
                        <a href="index.php?cible=generique&function=login">Retour à la connexion</a>
                    </div>
                </form>
            </div>
        </div>
